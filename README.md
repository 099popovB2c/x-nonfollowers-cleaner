...
It scans account cards that are currently loaded on your **Following** page, marks accounts that do not appear to show the **“Follows you”** relationship label, and provides both a **one-at-a-time** unfollow button and an optional **limited batch mode (1–100 accounts)**.

## Important

This project does **not** include unlimited or background unfollow automation.
...
- performs no background or unlimited mass-unfollow loop;
